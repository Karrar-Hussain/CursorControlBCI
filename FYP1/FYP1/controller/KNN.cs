...
namespace FYP1.controller
{
    class KNN
    {
        ...
        public bool buildKNNCorpus(string subName = "karrar")
        {
            fileExistance = false;
        ...
        public Tuple<int, int, int, int,int> getcount(Tuple<double[], double[], double[], double[],double[]> distance)
        {
            ...
            for (int i = 0; i < K; i++)
            {
                double distanced=100000, distancel=100000, distancer=100000, distanceu=100000, distancen = 100000;
